...
$contenedorletraacordes=document.querySelector(".contenedor-letra-acordes"),
$contenedorimgacordes=document.querySelector(".contenedor-img-acordes");

document.addEventListener("click", (e)=>{
   if (e.target.matches(".letra-tema")) {
    $contenedorletraacordes.classList.toggle("display-none");
    $btnacordestema.classList.toggle("display-none");
   }
